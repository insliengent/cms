<?php /*a:4:{s:52:"D:\wamp64\www\a\application\admin\view\book\lst.html";i:1573049058;s:56:"D:\wamp64\www\a\application\admin\view\public\_head.html";i:1573053339;s:56:"D:\wamp64\www\a\application\admin\view\public\_left.html";i:1573144658;s:56:"D:\wamp64\www\a\application\admin\view\public\_foot.html";i:1574854748;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<main class="main">
  ...
  <div class="page-body">
    ...
    <header class="head clearfix">
      <a href="<?php echo url('admin/book/add'); ?>" class="btn fl">添加书籍</a>

      <form class="serachform" id="serach" action="" method="post">
      ...
      <li>
      <div class="card">
        <a href="<?php echo url('admin/book/chapterlst', ['id' => $vo['id']]); ?>" class="img">
          <img src="<?php echo htmlentities($vo['img']); ?>" alt="">
        </a>
        <div class="con">
          <h2><a href="<?php echo url('admin/book/chapterlst', ['id' => $vo['id']]); ?>"><?php echo htmlentities($vo['title']); ?></a></h2>
          <a href="<?php echo url('admin/book/edit', ['id' => $vo['id']]); ?>">编辑书籍</a>
          <a href="<?php echo url('admin/book/chapterlst', ['id' => $vo['id']]); ?>">编辑章节</a>
        </div>
      </div>
    </li>
