<?php /*a:3:{s:52:"D:\wamp64\www\a\template\mobile\index\point\lst.html";i:1573049374;s:56:"D:\wamp64\www\a\template\mobile\index\public\header.html";i:1575098021;s:56:"D:\wamp64\www\a\template\mobile\index\public\footer.html";i:1575014386;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<div class="container">
  ...
  <div class="tit-list">
    <ul>
   <?php if(is_array($artLst) || $artLst instanceof \think\Collection || $artLst instanceof \think\Paginator): $i = 0; $__LIST__ = $artLst;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <li>
          <a href="<?php echo url('index/exam/art', ['id' => $vo['id']]); ?>" alt="<?php echo htmlentities($vo['title']); ?> 练习题"><?php echo htmlentities($vo['title']); ?></a>
        </li>
