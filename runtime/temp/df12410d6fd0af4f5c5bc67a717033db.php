<?php /*a:3:{s:51:"D:\wamp64\www\a\template\mobile\index\news\art.html";i:1575208422;s:56:"D:\wamp64\www\a\template\mobile\index\public\header.html";i:1575098021;s:56:"D:\wamp64\www\a\template\mobile\index\public\footer.html";i:1575208392;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<div class="container">
  ...
  <div class="post-mate">
    <?php if(($prv)!=null): ?>
    <div class="post-prv">
      上一篇：<a  href="<?php echo url('index/news/art', ['id' => $prv['id']]); ?>" title="<?php echo htmlentities($prv['title']); ?>"><?php echo htmlentities($prv['title']); ?></a>
    </div>
    <?php endif; if(($next)!=null): ?>
    <div class="post-next">
      下一篇：<a href="<?php echo url('index/news/art', ['id' => $next['id']]); ?>" title="<?php echo htmlentities($next['title']); ?>"><?php echo htmlentities($next['title']); ?></a>
    </div>
    <?php endif; ?>
  </div>
  <div class="post-related">
    <h2>相关新闻</h2>
    <ul>
    <?php if(is_array($relatedPost) || $relatedPost instanceof \think\Collection || $relatedPost instanceof \think\Paginator): $i = 0; $__LIST__ = $relatedPost;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    <li><a href="<?php echo url('index/news/art', ['id' => $vo['id']]); ?>"><?php echo htmlentities($vo['title']); ?></a></li>
