<?php /*a:4:{s:54:"D:\wamp64\www\a\application\admin\view\slider\lst.html";i:1573049062;s:56:"D:\wamp64\www\a\application\admin\view\public\_head.html";i:1573053339;s:56:"D:\wamp64\www\a\application\admin\view\public\_left.html";i:1573144658;s:56:"D:\wamp64\www\a\application\admin\view\public\_foot.html";i:1574854748;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
  ...
  <div class="page-body">
    <div class="widget">
      <header class="head clearfix">
        <a href="<?php echo url('admin/slider/add'); ?>" class="btn fl">添加幻灯片</a>
      </header>
       <div class="body">
         <table class="table">
          <thead>
           ...
           <tbody>
          <?php if(is_array($sliderlst) || $sliderlst instanceof \think\Collection || $sliderlst instanceof \think\Paginator): $i = 0; $__LIST__ = $sliderlst;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
          <tr>
            <td><?php echo htmlentities($vo['id']); ?></td>
            <td><input class="sort" type="text" name="sort" size="1" value="<?php echo htmlentities($vo['sort']); ?>" dataid="<?php echo htmlentities($vo['id']); ?>"></td>
            <td><a href="<?php echo url('admin/slider/edit', ['id' => $vo['id']]); ?>"><?php echo htmlentities($vo['title']); ?></a></td>
            <td><img src="<?php echo htmlentities($vo['img']); ?>" alt="" style="max-height: 80px;width: auto;"></td>
            <td class="text-center">
                <a href="<?php echo url('admin/slider/edit', ['id' => $vo['id']]); ?>">编辑</a>
...
$(function () {
  ...
  $('[name=sort]').change(function () {
    ...
    $.ajax({
      url:"<?php echo url('admin/slider/sort'); ?>",
      type:'post',
...
//删除
 $('.delete-btn').click(function (ev) {
    ...
    var id = $(this).val();
    $.ajax({
       url:"<?php echo url('admin/slider/del'); ?>",
       type:'post',
       data:{id:id},
       dataType:'json',
       success:function (data) {
