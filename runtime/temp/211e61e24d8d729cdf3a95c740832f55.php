<?php /*a:3:{s:53:"D:\wamp64\www\a\template\mobile\index\user\point.html";i:1573049376;s:56:"D:\wamp64\www\a\template\mobile\index\public\header.html";i:1575098021;s:56:"D:\wamp64\www\a\template\mobile\index\public\footer.html";i:1575208392;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<div class="container">
  <div>
    ...
    <div class="art-point">
      ...
      <a href="<?php echo url('index/point/art', ['id' => $vo['id']]); ?>"><?php echo htmlentities($vo['title']); ?></a>
    </div>
...
<script>
  $(window).scroll(
        ...
        if (scrollTop + windowHeight == scrollHeight) {
            ...
            $offect = $("#offect").val();
            $.post('<?php echo url("index/user/point"); ?>',{offect:$offect}, function(data){
                if(data != -1){
                    var array = eval("("+data+")");
                    var str = "";
                    for(var p in array){
                        str += '<div class="art-point"><i class="icon i-star" artid='+array[p].id+'></i><a href="<?php echo url("index/point/art", ["id" =>'+array[p].id+']); ?>">'+array[p].title+'</a></div>';
                    }
