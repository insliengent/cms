<?php /*a:3:{s:52:"D:\wamp64\www\a\template\mobile\index\exam\home.html";i:1574767817;s:56:"D:\wamp64\www\a\template\mobile\index\public\header.html";i:1575098021;s:56:"D:\wamp64\www\a\template\mobile\index\public\footer.html";i:1575208392;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<div class="container mtb8">
  ...
  <div class="book-home">
    <ul>
    <?php if(is_array($bookArr) || $bookArr instanceof \think\Collection || $bookArr instanceof \think\Paginator): $i = 0; $__LIST__ = $bookArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    <li>
      <a href="<?php echo url('index/exam/lst', ['id' => $vo['id']]); ?>" class="clearfix">
        <div class="l">
          <img src="<?php echo htmlentities($vo['img']); ?>" alt="">
        </div>
        <div class="r">
          <h2><?php echo htmlentities($vo['title']); ?></h2>
          <p>共<?php echo htmlentities($vo['exam_count']); ?>道题</p>
        </div>
      </a>
    </li>
