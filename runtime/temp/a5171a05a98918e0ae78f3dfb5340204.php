<?php /*a:4:{s:56:"D:\wamp64\www\a\application\admin\view\point\search.html";i:1573049060;s:56:"D:\wamp64\www\a\application\admin\view\public\_head.html";i:1573053339;s:56:"D:\wamp64\www\a\application\admin\view\public\_left.html";i:1573144658;s:56:"D:\wamp64\www\a\application\admin\view\public\_foot.html";i:1574854748;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
  ...
  <div class="page-body">
    <div class="widget">
      <header class="head clearfix">
        <a href="<?php echo url('admin/book/chapteradd'); ?>" class="add">添加章节</a>
<form class="serachform" id="serach" action="<?php echo url('admin/book/bookSearch'); ?>" method="post">
    ...
    <button type="submit" id="serach-submit">搜索</button>
      ...
      <tr>
        ...
        <td>
        <a href="<?php echo url('admin/book/chapteredit', ['bookid' => $vo['id']]); ?>"><?php echo htmlentities($vo['title']); ?></a>
        </td>
        <td>
        <a href="<?php echo url('admin/book/chapteredit', ['id' => $vo['id']]); ?>">编辑</a>
        <span class="chapterDel del" dataid="<?php echo htmlentities($vo['id']); ?>">删除</span>
        </td>
      </tr>
