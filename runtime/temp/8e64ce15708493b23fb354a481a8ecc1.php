<?php /*a:4:{s:59:"D:\wamp64\www\a\application\admin\view\book\chapterlst.html";i:1573049058;s:56:"D:\wamp64\www\a\application\admin\view\public\_head.html";i:1573053339;s:56:"D:\wamp64\www\a\application\admin\view\public\_left.html";i:1573144658;s:56:"D:\wamp64\www\a\application\admin\view\public\_foot.html";i:1574854748;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
  ...
  <div class="page-body">
    <div class="widget">
      <header class="head clearfix">
        <a href="<?php echo url('admin/book/chapteradd'); ?>" class="btn fl">添加章节</a>
      </header>
       <div class="body">
         <ul class="table-ul">
          <li class="thead">
          ...
          <?php if(is_array($genTree) || $genTree instanceof \think\Collection || $genTree instanceof \think\Paginator): $i = 0; $__LIST__ = $genTree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
           <li class="clearfix">
             <div class="row">
               <div class="td-title">
              <a href="<?php echo url('admin/exam/lst', ['id' => $vo['id']]); ?>"><?php echo htmlentities($vo['title']); ?></a>
            </div>
             ...
             <div class="td-mata">
              <a href="<?php echo url('admin/book/chapteredit', ['id' => $vo['id']]); ?>">编辑</a>
             ...
             <ul class="child">
               ...
               <li>
                <div class="row">
                 <div class="td-title">
                  <a href="<?php echo url('admin/exam/lst', ['id' => $child['id']]); ?>"><?php echo htmlentities($child['title']); ?></a>
                </div>
                 ...
                 <div class="td-mata">
                  <a href="<?php echo url('admin/book/chapteredit', ['id' => $child['id']]); ?>">编辑</a>
...
//获取子分类
  ...
  $(this).find('ul.table-ul>li').has('ul.child').prepend(openerHTML);
  ...
  $('[name=sort]').change(function () {
    ...
    $.ajax({
      url:"<?php echo url('admin/book/sort'); ?>",
      type:'post',
...
//删除
 $('.delete-btn').click(function (ev) {
    ...
    var id = $(this).val();
    $.ajax({
       url:"<?php echo url('admin/book/del'); ?>",
       type:'post',
       data:{id:id},
       dataType:'json',
       success:function (data) {
